...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
#| label: fig-raw-chromatogram-plot
...
Die EP-Befunde mit "unauffällig" scheinen konsistenter und einheitlicher als die iFix-Befundberichte mit "unauffällig" zu sein. Im zweiten random forest Model werde ich die Klassifizierung "unauffällig" und "auffällig" auf Basis der EP-Befunde durchführen.
