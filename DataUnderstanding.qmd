...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
#| label: fig-chromatogram-plot
#| fig-cap: "Chromatogramm einer Protein-Elektrophorese"
...
plot(decimal.values ~ ID, data = decimal.values, type = "p", pch = 20, col = "blue", lwd = 2, xlab = "ID", ylab = "signal", main = "")
```
<br>
...
#### Zusammenfassung der Befundtexte Analysen {.justify}
