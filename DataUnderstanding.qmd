...
Kleinschreibung, Entfernen von Satzzeichen und Stopwörtern, sowie Tokenisierung der Befundtexte.
...
EPcsv1 <- EPcsv |>
  mutate(
    Bef.ImFix_cleaned = gsub("\\([A-Z]{3}\\)", "", Bef.ImFix),
  ...
  filter(!Bef.ImFix_cleaned %in% stopwords("de"))|> 
