...
#### Bereinigung und Tokenisierung der Befundtexte
Kleinschreibung, Entfernen von Satzzeichen und Stopwörtern, sowie Tokenisierung der Befundtexte. daraus ergibt sich folgende Häufigkeitsverteilung der Wörter in den iFix-Befundtexten:
...
stopwords.olli <- setdiff(stopwords("de", "stopwords-iso"), c("nicht", "keine", "ohne"))
