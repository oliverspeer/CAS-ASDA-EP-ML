...
<!-- # zusätzliche Textauswertung, die durch clustering überflüssig wurde------------ -->
<!-- ```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE} -->
<!-- # alternative Methode mit tidymodel und tidytext -->
<!-- # Sparse-Matrix erstellen: Dokument-Term-Matrix -->
<!-- # dtm <- tri.grams  |>  -->
<!-- #   cast_sparse(ID, trigram, n) -->
<!-- #  -->
<!-- # # Daten als tibble (für tidymodels) -->
<!-- # dtm_tibble <- as_tibble(as.matrix(dtm)) -->
<!-- # dtm_tibble$id <- rownames(dtm) -->
<!-- #  -->
<!-- #  -->
<!-- #  # Clustering mit k-means (tidymodels) -->
<!-- #  set.seed(123) -->
<!-- #   -->
<!-- #  # Rezept für Clustering vorbereiten -->
<!-- #  rec <- recipe(~ ., data = dtm_tibble) |> -->
<!-- #    update_role(id, new_role = "id variable") |> -->
<!-- #    step_normalize(all_numeric_predictors()) -->
<!-- #   -->
<!-- #  # Modell definieren: k-means -->
<!-- #  kmeans_spec <- k_means(centers = 5) #|>   -->
<!-- #    #set_engine("stats") -->
<!-- #   -->
<!-- #  # Workflow erstellen -->
<!-- #  workflow <- workflow() |> -->
...
<!-- #    extract_fit_parsnip() |> -->
<!-- #    pluck("cluster") |> -->
<!-- #    enframe(name = "document", value = "cluster") -->
<!-- #   -->
<!-- #  # Ergebnisse mit Originaltexten verknüpfen -->
<!-- #  results <- texts |> -->
<!-- #    left_join(cluster_assignments, by = c("id" = "document")) -->
<!-- # #  -->
...
hex.string <- dev.df$curve[EPcsv1$ID == 28]
...
extract.peak.data <- function(peaks, max.peaks = 9) {
