...
dat_h2o <- readRDS("dev_man_EP_all.rds") |> 
...
hyper_params <- list(
  hidden = list(c(128, 64, 128), c(64, 32, 64), c(256, 128, 256)),  # Verschiedene Layer-Architekturen
  activation = c("Tanh", "Rectifier"),            # Verschiedene Aktivierungsfunktionen
  l1 = c(1e-5, 1e-4),                                         # L1-Regularisierung
...
reconstruction_error_unauf <- as.data.frame(h2o.anomaly(best_model, dat_h2o, per_feature = TRUE))
