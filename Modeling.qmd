...
### Ziel
[Das Modell muss die Klasse *"unauffällig"* mit einer Spezifität von ca. 80% und einem Negativ-Prädiktions-Wert (NPV) von 100% identifizieren.]{style="color:#0000B8;font-weight:bold"}
...
### Testmethodik
1) Hyperparamtertuning eines random forest mit 5-facher Kreuzvalidierung **(Trainigsdaten)**  
    -  10-fach Kreuzvalidierung wäre besser, aber aufgrund der Rechenintensität und Zeitmangels wird dies auf die Zeit nach dem CAS verschoben. 

2) Auswahl des besten random forst Models    
Metriken: ROC-AUC & NPV
...
4) Training logistischer Regressionen / Lasso-Regression mit diesen wichtigsten   Variablen **(Trainingsdaten)**    
...
- NPV 
- ROC-AUC
- informativ: Sensitivität, Spezifität, PPV, NPV, F-Measure, Accuracy, Kappa

## Erstellen der Modelle {.justify}
### Random Forest I {.justify}
- Klassifizierung: nach iFix Befunden  
- Features: Messignale (y-Werte), m, fdd, AUC  
...
#### Auswertung des Tuning {.justify}
```{r figtuningRF, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figtuningRF
#| fig-cap: "Tuning des Random Forest Modells für die iFix Befunde"
...
#| label: figfinetuningRF1
#| fig-cap: Feintuning des Random Forest Modells für die iFix Befunde
...
#### Auswahl des besten Modells {.justify}
...
#### Die wichtigsten Variablen {.justify}
...
#### Auswertung des EPB Tuning {.justify}
...
### RF III  11.1.25 {.justify}
- Klassifizierung: nach EP Befunden  
- Features: fdd, m, AUC

#### Fine-Tuning {.justify}
```{r finetuningIII grid, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
library(tidymodels)
EPB.all.training <- readRDS("EPB_all_training.rds")


# recipe building
EPB.rec <- 
  recipe(EPKlassifizierung ~ ., data = EPB.all.training) |>
  update_role(ID, new_role = "ID") 

# cross validation data setting
set.seed(8173)
EPfolds <- vfold_cv(EPB.all.training, v = 5)
EPfolds
...
```{r specs finetuning III, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
# tune setting
tune.spec <- rand_forest(
  mtry = tune(),
  trees = 1000,
...
```{r finetuningIII, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
library(future)

plan(multisession, workers = 5)

set.seed(8173)
regular.EPB.all.res <- tune_grid(
  tune.wf,
  resamples = EPfolds,
  metrics = metric_set(roc_auc, sens, spec, npv),
  grid = rf.grid,
...
saveRDS(regular.EPB.all.res, "regular_EPB_all_resRF_npv.rds")

```

```{r figfinetuning III, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningIII
#| fig-cap: Feintuning des Random Forest Modells für die EP Befunde mit m, fdd & AUC
#| 
regular.res <- readRDS("regular_EPB_all_resRF_npv.rds")
regular.res |>
  collect_metrics() |>
  filter(.metric == "roc_auc") |>
  mutate(min_n = factor(min_n)) |>
...
```{r figfinetuning IIInpv, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningIII-npv
#| fig-cap: 2. Feintuning des Random Forest Modells für die EP Befunde Basis NPV
#| 
regular.res <- readRDS("regular_EPB_all_resRF_npv.rds")
regular.res |>
...
#### Auswahl des besten Modells {.justify}
```{r bestmodelRFIIIauc, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
regular.res <- readRDS("regular_EPB_all_resRF_npv.rds")
best.auc <- select_best(regular.res, metric = "roc_auc")
best.auc
...
saveRDS(final.rf, "final_EPB_all_rf.rds")

final.rf
```

```{r bestmodelRFIIInpv, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
regular.res <- readRDS("regular_EPB_all_resRF_npv.rds")
best.npv <- select_best(regular.res, metric = "npv")
best.npv
...
saveRDS(final.rf.npv, "final_EPB_all_rf_npv.rds")

final.rf.npv
```

### Random Forest IV {.justify}
- Klassifizierung: iFixBefunde habe ich zusammen mit GPT-4o klassifiziert, sortiert, und manuel korrigiert.
- Klassen: unauffällig, M-Protein, Suspicous
- Features: y-Signal-Werte, fdd, m, AUC

#### Fine-Tuning {.justify}
```{r finetuningIV grid, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
library(tidymodels)
GPT.training <- readRDS("GPT_training.rds")


# recipe building
EP.rec <- 
  recipe(Classification ~ ., data = GPT.training) |>
  update_role(ID, new_role = "ID") 

# cross validation data setting
set.seed(8173)
EPfolds <- vfold_cv(GPT.training, v = 5)
EPfolds
...
```{r specs finetuning IV, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
# tune setting
tune.spec <- rand_forest(
  mtry = tune(),
  trees = 1000,
...
```{r finetuningIV, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
library(future)
...
saveRDS(res.RF, "GPT_resRF.rds")

```

```{r figfinetuning IV, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningIVauc
#| fig-cap: Feintuning des Random Forest Modells für die EP Befunde mit m, fdd & AUC
#| 
res.RF <- readRDS("GPT_resRF.rds")
res.RF |>
  collect_metrics() |>
  filter(.metric == "roc_auc") |>
  mutate(min_n = factor(min_n)) |>
...
```{r figfinetuning IVnpv, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningIV-npv
#| fig-cap: 2. Feintuning des Random Forest Modells für die EP Befunde Basis NPV
#| 
res.RF <- readRDS("GPT_resRF.rds")
res.RF |>
...
#### Auswahl des besten Modells {.justify}
```{r bestmodelRFIVauc, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
regular.res <- readRDS("GPT_resRF.rds")
best.auc <- select_best(regular.res, metric = "roc_auc")
best.auc

final.rf <- finalize_model(tune.spec, best.auc)

saveRDS(final.rf, "final_GPT_rf_auc.rds")

final.rf
```

```{r bestmodelRFIVnpv, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
regular.res <- readRDS("GPT_resRF.rds")
best.npv <- select_best(regular.res, metric = "npv")
best.npv
...
saveRDS(final.rf.npv, "final_GPT_rf_npv.rds")

final.rf.npv
```


### Random Forest V {.justify}
- Klassifizierung: nach EP Befunden manuell bereinigt
- Klassen: unauffällig, Suspicous
- Features: fdd, m mit autoencoder die features identifiziert, die die grösste Rekontruktionsdifferenz haben

#### Fine-Tuning {.justify}
```{r finetuningV grid, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
library(tidymodels)
EP50.training <- readRDS("EP50_training.rds")


# recipe building
EP.rec <- 
  recipe(EPKlasse ~ ., data = EP50.training) |>
  update_role(ID, new_role = "ID") 

# cross validation data setting
set.seed(8173)
EPfolds <- vfold_cv(EP50.training, v = 5)
EPfolds
...
```{r specs finetuning V, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
# tune setting
tune.spec <- rand_forest(
  mtry = tune(),
  trees = 1000,
...
```{r finetuningV, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
library(future)
...
saveRDS(res.RF, "EP50_resRF.rds")

```

```{r figfinetuning V, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningV
#| fig-cap: Feintuning des Random Forest Modells für die EP Befunde mit m, fdd & AUC
#| 
res.RF <- readRDS("EP50_resRF.rds")
res.RF |>
  collect_metrics() |>
  filter(.metric == "roc_auc") |>
  mutate(min_n = factor(min_n)) |>
...
```{r figfinetuning Vnpv, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningV-npv
#| fig-cap: 2. Feintuning des Random Forest Modells für die EP Befunde Basis NPV
#| 
res.RF <- readRDS("EP50_resRF.rds")
res.RF |>
...
#### Auswahl des besten Modells {.justify}
```{r bestmodelRFVauc, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
regular.res <- readRDS("EP50_resRF.rds")
best.auc <- select_best(regular.res, metric = "roc_auc")
best.auc

final.rf <- finalize_model(tune.spec, best.auc)

saveRDS(final.rf, "final_EP50_rf_auc.rds")

final.rf
```

```{r bestmodelRFVnpv, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
regular.res <- readRDS("EP50_resRF.rds")
best.npv <- select_best(regular.res, metric = "npv")
best.npv
...
saveRDS(final.rf.npv, "final_EP50_rf_npv.rds")

final.rf.npv
```


### Random Forest VI {.justify}
- Klassifizierung: durch autoencoder trainiert mit unauffälligen EP & iFix Befunden
- Klassen: unauffällig, Suspicous
- Features: y, m, fdd

#### Fine-Tuning {.justify}
```{r finetuningVI grid, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
library(tidymodels)
all.data.training <- readRDS("all_data_training.rds")


# recipe building
EP.rec <- 
  recipe(Classification ~ ., data = all.data.training) |>
  update_role(ID, new_role = "ID") 

# cross validation data setting
set.seed(8173)
EPfolds <- vfold_cv(all.data.training, v = 5)
EPfolds
...
```{r specs finetuning VI, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
# tune setting
tune.spec <- rand_forest(
  mtry = tune(),
  trees = 1000,
...
```{r finetuningVI, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
library(future)
...
saveRDS(res.RF, "all_data_resRF.rds")

```

```{r figfinetuning VI, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningVI
#| fig-cap: Feintuning des Random Forest Modells für die H2O-Klassifizierung mit m, fdd & AUC
#| 
res.RF <- readRDS("all_data_resRF.rds")
res.RF |>
  collect_metrics() |>
  filter(.metric == "roc_auc") |>
  mutate(min_n = factor(min_n)) |>
...
```{r figfinetuning VInpv, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningVI-npv
#| fig-cap: Feintuning des Random Forest Modells für die H2O Klassifizierung Basis NPV
#| 
res.RF <- readRDS("all_data_resRF.rds")
res.RF |>
  collect_metrics() |>
...
#### Auswahl des besten Modells {.justify}
```{r bestmodelRFVIauc, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
regular.res <- readRDS("all_data_resRF.rds")
best.auc <- select_best(regular.res, metric = "roc_auc")
best.auc

final.rf <- finalize_model(tune.spec, best.auc)

saveRDS(final.rf, "final_all_data_rf_auc.rds")

final.rf
```

```{r bestmodelRFVInpv, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
regular.res <- readRDS("all_data_resRF.rds")
best.npv <- select_best(regular.res, metric = "npv")
best.npv
...
saveRDS(final.rf.npv, "final_all_data_rf_npv.rds")

final.rf.npv
```


### Random Forest VII {.justify}
- Klassifizierung: durch autoencoder trainiert mit unauffälligen EP & iFix, und auch M-Gradient & M-Ptoein positiven Befunden
- Klassen: unauffällig, Suspicous, M-Gradient
- Features: y, m, fdd

#### Fine-Tuning {.justify}
```{r finetuningVII grid, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
library(tidymodels)
all.data.training <- readRDS("all_data_mgrad_training.rds")


# recipe building
EP.rec <- 
  recipe(Class ~ ., data = all.data.training) |>
  update_role(ID, new_role = "ID") 
...
```{r specs finetuning VII, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
# tune setting
tune.spec <- rand_forest(
  mtry = tune(),
  trees = 1000,
...
```{r finetuningVII, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
library(future)
...
saveRDS(res.RF, "all_data_mgrad_resRF.rds")

```

```{r figfinetuning VII, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningVII
#| fig-cap: Feintuning des Random Forest Modells für die H2O-Klassifizierung mit m, fdd & AUC
#| 
res.RF <- readRDS("all_data_mgrad_resRF.rds")
res.RF |>
  collect_metrics() |>
  filter(.metric == "roc_auc") |>
  mutate(min_n = factor(min_n)) |>
...
```{r figfinetuning VIInpv, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningVII-npv
#| fig-cap: Feintuning des Random Forest Modells für die H2O Klassifizierung Basis NPV
#| 
res.RF <- readRDS("all_data_mgrad_resRF.rds")
res.RF |>
...
#### Auswahl des besten Modells {.justify}
```{r bestmodelRFVIIauc, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
regular.res <- readRDS("all_data_mgrad_resRF.rds")
best.auc <- select_best(regular.res, metric = "roc_auc")
best.auc

final.rf <- finalize_model(tune.spec, best.auc)

saveRDS(final.rf, "final_all_data_mgrad_rf_auc.rds")

final.rf
```

```{r bestmodelRFVIInpv, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
regular.res <- readRDS("all_data_mgrad_resRF.rds")
best.npv <- select_best(regular.res, metric = "npv")
best.npv
...
saveRDS(final.rf.npv, "final_all_data_mgrad_rf_npv.rds")

final.rf.npv
```


### Random Forest VIII {.justify}
- Klassifizierung: durch autoencoder trainiert mit unauffälligen EP & iFix, und auch M-Gradient & M-Ptoein positiven Befunden
- Klassen: unauffällig, Suspicous, M-Gradient
- Features: y, m, fdd

#### Fine-Tuning {.justify}
```{r finetuningVIII grid, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
library(tidymodels)
all.data.training <- readRDS("allf_data_mgrad_training.rds")


# recipe building
EP.rec <- 
  recipe(ClassAll ~ ., data = all.data.training) |>
  update_role(ID, new_role = "ID") 
...
```{r specs finetuning VIII, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
# tune setting
tune.spec <- rand_forest(
  mtry = tune(),
  trees = 1000,
...
```{r finetuningVIII, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
library(future)
...
saveRDS(res.RF, "allf_data_mgrad_resRF.rds")

```

```{r figfinetuning VIII, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningVIII
#| fig-cap: Feintuning des Random Forest Modells für die H2O-Klassifizierung mit m, fdd & AUC
#| 
res.RF <- readRDS("allf_data_mgrad_resRF.rds")
res.RF |>
  collect_metrics() |>
  filter(.metric == "roc_auc") |>
  mutate(min_n = factor(min_n)) |>
...
```{r figfinetuning VIIInpv, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: figfinetuningVIII-npv
#| fig-cap: Feintuning des Random Forest Modells für die H2O Klassifizierung Basis NPV
#| 
res.RF <- readRDS("allf_data_mgrad_resRF.rds")
res.RF |>
...
#### Auswahl des besten Modells {.justify}
```{r bestmodelRFVIIIauc, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
regular.res <- readRDS("all_data_mgrad_resRF.rds")
best.auc <- select_best(regular.res, metric = "roc_auc")
best.auc
...
saveRDS(final.rf, "final_allf_data_mgrad_rf_auc.rds")

final.rf
```

```{r bestmodelRFVIIInpv, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
regular.res <- readRDS("all_data_mgrad_resRF.rds")
best.npv <- select_best(regular.res, metric = "npv")
best.npv
...
saveRDS(final.rf.npv, "final_allf_data_mgrad_rf_npv.rds")
...
#### Model-Fit mit den Top 50 fdd: recipe, tuning spec, workflow, 10x resempling {.justify}

```{r logistic-regression-formula, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
# Daten einlesen
EPBtraining <- readRDS("EPBtraining.rds")
...
# cross validation
set.seed(8173)
EPboot <- bootstraps(EPBtraining, strata = EPKlassifizierung, times = 5)
...
<!-- #### Fit und Vorhersagen mit der Lasso-Regression nach Tuning für ROC-AUC {.justify} -->
...
<!-- #### Fit und Vorhersagen mit der Lasso-Regression nach Tuning für NPV {.justify} -->
