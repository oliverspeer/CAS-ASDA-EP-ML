...
## Random Forrest VI  {.justify}
alle y, m & fdd, autoencoder Klassifizierung mittels Rekonstruktionsfehler nach Training mit unauffälligen Chromatogrammen

```{r, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
# Daten einlesen
#EPtraining <- readRDS("EPBtraining.rds")
EPvalidation <- readRDS("all_data_validation.rds")
...
# read model
final.rf.auc <- readRDS("final_all_data_rf_auc.rds") |> 
  set_engine("ranger", num.threads = 1)
...
saveRDS(rf.auc.res, "rf_all_data_auc_res.rds")
```

### Metriken {.justify}

```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: tab-metrics-rfVI-auc
#| tbl-cap: Metriken des Random Forrest VI für AUC
rf.res <- readRDS("rf_all_data_auc_res.rds")
rf.res |> 
  collect_metrics()|> 
  mutate(
    metric = .metric,
...
```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: fig-rfVI-auc-conf-mat-plot
#| fig-cap: Confusion Matrix des Random Forrest VI für AUC
rf.res |> 
  collect_predictions() |>  
  conf_mat(truth = Classification, estimate = .pred_class) |> 
  autoplot(type = "heatmap")
...
## Random Forrest VI mit EP Befund-Text-Klassifikation nach NPV getuned {.justify}
50 autoencoder selektierte Features  und Klassifikation nach manuel bereinigten EP-Befunden
```{r, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
# Daten einlesen
#EPtraining <- readRDS("EPBtraining.rds")
...
# read model
final.rf <- readRDS("final_all_data_rf_npv.rds") |> 
  set_engine("ranger", num.threads = 1)
...
saveRDS(rf.res, "rf_all_data_npv_res.rds")
```

### Metriken {.justify}

```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: tab-metrics-rfVI-npv
#| tbl-cap: Metriken des Random Forrest VI für NPV
rf.res <- readRDS("rf_all_data_npv_res.rds")
rf.res |> 
  collect_metrics()|> 
  mutate(
    metric = .metric,
...
```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: fig-rfVI-npv-conf-mat-plot
#| fig-cap: Confusion Matrix des Random Forrest V für NPV
rf.res |> 
  collect_predictions() |>  
  conf_mat(truth = Classification, estimate = .pred_class) |> 
...
## Random Forrest VII  {.justify}
alle y, m & fdd, autoencoder Klassifizierung mittels Rekonstruktionsfehler nach Training mit unauffälligen Chromatogrammen und M-Gradienten

```{r, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
# Daten einlesen
#EPtraining <- readRDS("EPBtraining.rds")
EPvalidation <- readRDS("all_data_mgrad_validation.rds")
...
# recipe building
rf.rec <- 
  recipe(Class ~ ., data = EPvalidation) |>
  update_role(ID, new_role = "ID") 
...
# read model
final.rf.auc <- readRDS("final_all_data_mgrad_rf_auc.rds") |> 
  set_engine("ranger", num.threads = 1)
...
saveRDS(rf.auc.res, "rf_all_data_mgrad_auc_res.rds")
```

### Metriken {.justify}

```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: tab-metrics-rfVII-auc
#| tbl-cap: Metriken des Random Forrest VII für AUC
rf.res <- readRDS("rf_all_data_mgrad_auc_res.rds")
rf.res |> 
  collect_metrics()|> 
  mutate(
    metric = .metric,
...
```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: fig-rfVII-auc-conf-mat-plot
#| fig-cap: Confusion Matrix des Random Forrest VII für AUC
rf.res |> 
  collect_predictions() |>  
...
## Random Forrest VII mit EP Befund-Text-Klassifikation nach NPV getuned {.justify}
50 autoencoder selektierte Features  und Klassifikation nach manuel bereinigten EP-Befunden
```{r, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
# Daten einlesen
#EPtraining <- readRDS("EPBtraining.rds")
...
# read model
final.rf <- readRDS("final_all_data_mgrad_rf_npv.rds") |> 
  set_engine("ranger", num.threads = 1)
...
saveRDS(rf.res, "rf_all_data_mgrad_npv_res.rds")
```

### Metriken {.justify}

```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: tab-metrics-rfVII-npv
#| tbl-cap: Metriken des Random Forrest VI für NPV
rf.res <- readRDS("rf_all_data_mgrad_npv_res.rds")
rf.res |> 
  collect_metrics()|> 
  mutate(
    metric = .metric,
...
```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: fig-rfVII-npv-conf-mat-plot
#| fig-cap: Confusion Matrix des Random Forrest VII für NPV
rf.res |> 
  collect_predictions() |>  
  conf_mat(truth = Class, estimate = .pred_class) |> 
  autoplot(type = "heatmap")
...
## Random Forrest VIII  {.justify}
alle y, m & fdd, autoencoder Klassifizierung mittels Rekonstruktionsfehler nach Training mit unauffälligen Chromatogrammen und M-Gradienten  mit all 

```{r, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
# Daten einlesen
#EPtraining <- readRDS("EPBtraining.rds")
EPvalidation <- readRDS("allf_data_mgrad_validation.rds")
...
# recipe building
rf.rec <- 
  recipe(ClassAll ~ ., data = EPvalidation) |>
  update_role(ID, new_role = "ID") 
...
# read model
final.rf.auc <- readRDS("final_allf_data_mgrad_rf_auc.rds") |> 
  set_engine("ranger", num.threads = 1)
...
saveRDS(rf.auc.res, "rf_allf_data_mgrad_auc_res.rds")
```

### Metriken {.justify}

```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: tab-metrics-rfVIII-auc
#| tbl-cap: Metriken des Random Forrest VIII für AUC
rf.res <- readRDS("rf_allf_data_mgrad_auc_res.rds")
rf.res |> 
  collect_metrics()|> 
  mutate(
    metric = .metric,
...
```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: fig-rfVIII-auc-conf-mat-plot
#| fig-cap: Confusion Matrix des Random Forrest VII für AUC
rf.res |> 
  collect_predictions() |>  
  conf_mat(truth = ClassAll, estimate = .pred_class) |> 
  autoplot(type = "heatmap")
```


## Random Forrest VIII mit EP Befund-Text-Klassifikation nach NPV getuned {.justify}
autoencoder mit allen Features  und Klassifikation in "unauffällig", "M-Gradient" & "suspicious"
```{r, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
# Daten einlesen
#EPtraining <- readRDS("EPBtraining.rds")
EPvalidation <- readRDS("allf_data_mgrad_validation.rds")
...
# read model
final.rf <- readRDS("final_allf_data_mgrad_rf_npv.rds") |> 
  set_engine("ranger", num.threads = 1)
...
saveRDS(rf.res, "rf_allf_data_mgrad_npv_res.rds")
```

### Metriken {.justify}

```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: tab-metrics-rfVIII-npv
#| tbl-cap: Metriken des Random Forrest VI für NPV
rf.res <- readRDS("rf_allf_data_mgrad_npv_res.rds")
rf.res |> 
  collect_metrics()|> 
  mutate(
    metric = .metric,
...
```{r, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
#| label: fig-rfVIII-npv-conf-mat-plot
#| fig-cap: Confusion Matrix des Random Forrest VII für NPV
rf.res |> 
  collect_predictions() |>  
  conf_mat(truth = ClassAll, estimate = .pred_class) |> 
...
model.compare <- bind_rows(rfI.m, rfII.m, rfII.npv.m, rfIII.m, rfIII.npv.m, rfIV.m, rfIV.npv.m, rfV.m, rfV.npv.m, rfVI.m, rfVI.npv.m, rfVII.m, rfVII.npv.m, rfVIII.m, rfVIII.npv.m, log.m, log.all.m, lasso.m) |> 
